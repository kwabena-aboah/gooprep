  ...
  <aside class="gp-sidebar" :class="{ hidden: !open }">
    ...
    <nav class="py-2 pb-5">
      ...
      <template v-if="auth.isAdmin">
        ...
        <RouterLink class="sidebar-link" :class="{active:isActive('/admin/institutions')}" to="/admin/institutions"><i class="bi bi-building"></i>Institution Approvals</RouterLink>
